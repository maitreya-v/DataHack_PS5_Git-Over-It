...
//     const url =
//       "https://3075-2409-40c0-47-d56c-9590-8abf-c2a4-649c.ngrok-free.app/resume_parse";
...
//   return (
//     <div
//     // className="flex items-center justify-center w-full h-full px-2 mb-4 16 mt- md:mx-0 md:px-0 lg:mb-10 lg:items-center lg:justify-start"
//     >
...
export default function SignIn() {
  ...
  function handleResume(event) {
    ...
    event.preventDefault();
    const url =
      "https://0f41-2409-40c0-7b-18d0-4590-7720-269b-bf08.ngrok-free.app/resume_parse";
    const formData = new FormData();
    formData.append("file", file);
    formData.append("fileName", file.name);
    const config = {
        ...
        axios
          ...
          .then((response) => {
            Swal.fire({
              ...
              text: "Profile Created succesfully",
              icon: "success",
